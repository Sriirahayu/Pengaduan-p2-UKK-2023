...
<nav class="navbar navbar-expand-lg bg-success navbar-dark position-sticky top-0 z-full shadow-sm">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form action="{{Route('logout')}}" method="post">
            @csrf
            <button type="submit" class="fw-semibold btn btn-success fs-6">Logout</button>
        </form>
      </div>
    </div>
</nav>
